...
namespace GeoServices_Core_Commons.Core
{
    public class GeoService : IGeoService
    {
        ...
        public GeocallResponse<F1rDisplay, F1rResponse> Function1R(FunctionInput input)
        {
            ...
            if (string.Equals(input.DisplayFormat, "false", StringComparison.OrdinalIgnoreCase))
            {
                GeocallResponse<F1rDisplay, F1rResponse> raw = new GeocallResponse<F1rDisplay, F1rResponse>
                {
                    display = null,
            ...
            {
                GeocallResponse<F1rDisplay, F1rResponse> goatlike = new GeocallResponse<F1rDisplay, F1rResponse>
                {
                    display = new F1rDisplay(wa1),
                    root = null
                };
        ...
        public GeocallResponse<F3cDisplay, F3cResponse> Function3_F3C(FunctionInput input)
        {
            //work area setup & marshall validated inputs into wa1
        ...
        public GeocallResponse<F3Display, F3Response> Function3_F3(FunctionInput input)
        {
            //work area setup & marshall validated inputs into wa1
            //NOTE: we will set the function code *after* input validation to check for presence of compass direction. This is to allow the controller to serve F3 or F3C accordingly
            Wa1 wa1 = new Wa1
        ...
        public GeocallResponse<F5Display, F5Response> Function5(FunctionInput input)
        {
            ...
            if (string.IsNullOrWhiteSpace(input.StreetCode))
            {
                wa1.in_b10sc1.Clear();
            ...
            {
                wa1.in_b10sc1.Clear();
                wa1.in_b10sc1.B10scFromString(input.StreetCode);
        ...
        public GeocallResponse<FBFDisplay, FBFResponse> FunctionBF(FunctionInput input)
        {
            ...
            if (string.Equals(input.DisplayFormat, "false", StringComparison.OrdinalIgnoreCase))
            {
                GeocallResponse<FBFDisplay, FBFResponse> raw = new GeocallResponse<FBFDisplay, FBFResponse>
                {
                    display = null,
                    root = new FBFResponse(wa1)
                };
            ...
            {
                GeocallResponse<FBFDisplay, FBFResponse> goatlike = new GeocallResponse<FBFDisplay, FBFResponse>
                {
        ...
        public GeocallResponse<FHRDisplay, FHRResponse> FunctionHR(FunctionInput input)
        {
            //work area setup
            Wa1 wa1 = new Wa1
            {
